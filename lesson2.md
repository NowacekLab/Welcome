...
We also may have code that we want to contribute to the repository for others to use OR we may want to work on a new project collboratively.  There are two ways to start a new repo, either of which may be more useful depending on the way your project may already exist locally.

**Option #1: Starting on GitHub**
...
**Option #2: Starting in GitHub Desktop**
